...
public class AgentsAppState extends AbstractAppState{
     ...
     */
    protected List<GameObjectControl> gameObjects;

    protected AgentsAppState() {
        agents = new LinkedList<Agent>();
        gameObjects = new LinkedList<GameObjectControl>();
    }
     ...
     */
    public List<GameObjectControl> look(Agent agent, float viewAngle) {
        ...
        for (GameObjectControl gameObject : gameObjects) {
     ...
     * @return
     */
    public boolean lookable(Agent observer, GameObjectControl gameObject, float viewAngle) {
    ...
    public List<GameObjectControl> getGameObjects() {
        return gameObjects;
    }
    ...
    public void addGameObject(GameObjectControl gameObject) {
        gameObjects.add(gameObject);
    }

    public void removeGameObject(GameObjectControl gameObject) {
