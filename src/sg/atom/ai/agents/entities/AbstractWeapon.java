 ...
 * @version 1.0
 */
public abstract class AbstractWeapon extends GameObjectControl {
     ...
     * @return
     */
    public boolean isInRange(GameObjectControl target) {
    ...
    public void attack(Vector3f direction, float tpf) {
        ...
        if (firedBullet != null) {
            ...
            AgentsAppState.getInstance().addGameObject(firedBullet);
        }
        //set weapon cooldown
     ...
     * @param tpf time per frame
     */
    public void attack(GameObjectControl target, float tpf) {
