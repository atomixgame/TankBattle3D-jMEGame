 ...
 * for more details.
 * <p>
 * An {@link InputListener} can receive all the basic input events. More complex listeners (like {@link } and
...
//				}
	...
	public void setX (float x) {
		if (getLocalTranslation().x != x) {
			getLocalTranslation().x = x;
			positionChanged();
		}
	}
	...
	public void setY (float y) {
		if (getLocalTranslation().x != y) {
			getLocalTranslation().x = y;
			positionChanged();
		}
	}
	...
	public void setPosition (float x, float y) {
		if (getLocalTranslation().x != x || getLocalTranslation().y != y) {
			getLocalTranslation().x = x;
			getLocalTranslation().y = y;
			positionChanged();
		}
	}
	...
	public void setCenterPosition (float x, float y) {
		...
		if (getLocalTranslation().x != newX || getLocalTranslation().y != newY) {
			getLocalTranslation().x = newX;
			getLocalTranslation().y = newY;
			positionChanged();
		}
	}

	public float getCenterX () {
		return getLocalTranslation().x + width / 2;
	}

	public float getCenterY () {
		return getLocalTranslation().y + height / 2;
	}
	...
	public float getTop () {
		return getLocalTranslation().y + height;
	}

	/** Returns x plus width. */
	public float getRight () {
		return getLocalTranslation().x + width;
	}
...
//	}
	...
	public void setScaleY (float scaleY) {
		this.getLocalScale().y = scaleY;
	}

	/** Sets the scale for both X and Y */
	public void setScale (float scaleXY) {
		this.getLocalScale().x = scaleXY;
		this.getLocalScale().y = scaleXY;
	}
	...
	public void scaleBy (float scale) {
		getLocalScale().x += scale;
		getLocalScale().y += scale;
	}
