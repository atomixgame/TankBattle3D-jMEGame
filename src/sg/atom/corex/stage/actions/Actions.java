...
import sg.atom.corex.stage.Touchable;
...
public class Actions {
	...
	static public ColorAction color (ColorRGBA color) {
		return color(color, 0, null);
	}

	/** Transitions from the color at the time this action starts to the specified color. */
	static public ColorAction color (ColorRGBA color, float duration) {
		return color(color, duration, null);
	}

	/** Transitions from the color at the time this action starts to the specified color. */
	static public ColorAction color (ColorRGBA color, float duration, Interpolation interpolation) {
